  ...
  return (
    ...
    <div className='grid lg:grid-cols-3 sm:grid-cols-1 gap-2 items-center justify-center'>
        ...
        <div className='flex flex-col gap-2 place-items-center mb-45 box-border w-5/6 p-4 m-auto'>
            ...
            <div className='text-base flex flex-col items-center'>
                <h1 className='text-2xl flex flex-col'>Social Awareness<span className='bg-yellow w-full h-1'></span></h1>
                <p>We provide resources, conduct awareness campaigns, and facilitate access to hygiene facilities, aiming to create a healthier environment and prevent the spread of diseases.</p>
            </div>
        </div>
        <div className='flex flex-col gap-2 place-items-center mb-45 box-border w-5/6 p-4 m-auto'>
        ...
        <div className='flex flex-col gap-2 place-items-center mb-45 box-border w-5/6 p-4 m-auto'>
            ...
            <div className='bg-yellow h-5/6 w-1'></div>
            <div className='text-base flex flex-col items-center'>
                <h1 className='text-2xl flex flex-col'>Health Care<span className='bg-yellow w-full h-1'></span></h1>
        ...
        <div className='flex flex-col gap-2 place-items-center mb-45 box-border w-5/6 p-4 m-auto'>
            ...
            <div className='bg-yellow h-5/6 w-1'></div>
            <div className='text-base flex flex-col items-center'>
                <h1 className='text-2xl flex flex-col'>Primary Education<span className='bg-yellow w-full h-1'></span></h1>
        ...
        <div className='flex flex-col gap-2 place-items-center mb-45 box-border w-5/6 p-4 m-auto'>
            ...
            <div className='bg-yellow h-5/6 w-1'></div>
            <div className='text-base flex flex-col items-center'>
                <h1 className='text-2xl flex flex-col'>Social Care<span className='bg-yellow w-full h-1'></span></h1>
